...
function alerthome() {
  ...
  window.location.href="testing0.php?subject_id=1&begin=1&length=10";
}
...
if(quiz == 1 && count == 10) {
window.location.href="testing0.php?subject_id=2&begin=1&length=15";
} else if(quiz == 2 && count == 15) {
window.location.href="testing0.php?subject_id=3&begin=1&length=10";
} else if(quiz == 3 && count == 10) {
window.location.href="testing0.php?subject_id=4&begin=1&length=14";
} else if(quiz == 4 && count == 14) {
window.location.href="testing0.php?subject_id=5&begin=1&length=16";
...
window.location.href="smell0.php?resultToSmell="+ sessionStorage.getItem("resultToSmell");
}
else {
...
//  document.getElementById("result2").innerHTML = "You Point :" + extraversion.toFixed(2) + " % Status : " + textExtraversion + "<br>";
 ...
 if(openness > 0){
   if(openness >= 82.22){
     textOpenness = "เด่น";
           resultToSmell += "'05','06','08','12','15','16',";
             sessionStorage.setItem("resultToSmell", resultToSmell);
